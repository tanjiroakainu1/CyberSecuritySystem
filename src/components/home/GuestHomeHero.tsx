...
export function GuestHomeHero({ activeUsers, incidentCount }: GuestHomeHeroProps) {
  const pillars = [
    { icon: '🛡️', title: 'Protect', desc: 'Enterprise-grade security controls' },
    { icon: '📊', title: 'Monitor', desc: 'Real-time incidents & alerts' },
    { icon: '✓', title: 'Comply', desc: 'Policies, training & audits' },
  ];
      ...
      <div className="guest-hero-content">
        <div className="guest-hero-top">
          ...
          <div className="guest-hero-text">
            <span className="guest-hero-eyebrow">Enterprise Cybersecurity Platform</span>
            <h1 className="guest-hero-title">
              Cybersecurity
              <span className="guest-hero-title-accent"> Management System</span>
            </h1>
            <p className="guest-hero-desc">
              One secure hub for monitoring, incidents, risk, compliance, and training — built for
        ...
        <div className="guest-pillars">
          {pillars.map((p) => (
            <div key={p.title} className="guest-pillar">
              <span className="guest-pillar-icon">{p.icon}</span>
              <div>
        ...
        <div className="guest-cta-row">
          ...
          <Link to="/register" className="guest-cta-ghost">
            Create Account →
          </Link>
        </div>
